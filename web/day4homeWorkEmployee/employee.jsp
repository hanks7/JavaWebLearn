<%@ page import="com.yidao.jdbc.imooc.day4homeWorkEmployee.Employee" %>
...
<head>
    ...
    <title>员工列表</title>
    <link href="day4homeWorkEmployee/css/bootstrap.css" type="text/css" rel="stylesheet"/>

    <script type="text/javascript" src="day4homeWorkEmployee/js/jquery-1.11.1.min.js"></script>
    <script type="text/javascript" src="day4homeWorkEmployee/js/bootstrap.js"></script>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/jdbc/create" method="post" >
