...
public class RsaHelper2 {
    ...
    public RsaHelper2(String appId) {
        this.appId = appId;
...
//    }
    ...
    public String sign(String content, String privateBase64) {
        ...
        param.put("signType", "RSA");
        param.put("format", "JSON");
        param.put("timestamp", "1548038131318");
        param.put("version", "1.0");
        param.put("serialNo", "YDKJ20190121103450o7lKHtGK");
        param.put("bizContent", encode3Des(content));
        Ulog.i("putPairsSequenceAndTogether(param)", putPairsSequenceAndTogether(param));
